...
Roll no. :- 73
"""
#Program to implement set operation
...
return len(lst3)
# Function for finding List of students who play either cricket or badminton but
not both
def eCeB(lst1,lst2):
...
return len(lst4)
# Function for finding number of students who play cricket and football but not
badminton
...
print("The list of students playing cricket after removing duplicates : "
+str(Cricket))
...
print("The list of students playing football after removing duplicates : "
+str(Football))
...
print("The list of students playing badminton after removing duplicates : "
+str(Badminton))
flag=1
while flag==1:
print("\n\n******************MENU*******************\n")
...
print("Number of students who play either cricket or badminton but not
both : ", eCeB(Cricket, Badminton))
a = input("\n\nDo you want to continue (yes/no) :")
if a == "yes":
flag = 1
else:
...
badminton : ", CBnF(Cricket,Football,Badminton))
a = input("\n\nDo you want to continue (yes/no) :")
if a == "yes":
flag = 1
else:
...
"""
*********************************OUTPUT******************************************
Enter number of students in SE COMP: 6
Enter the names of 6 students (Please press ENTER after entering each students
name) :
Avishkar
Onkar
om
...
sahil
yogiraj
Original list of students in SEComp : ['Avishkar', 'Onkar', 'om', 'raj', 'sahil',
'yogiraj']
Enter number of students who play cricket : 2
Enter the names of 2 students who play cricket (Please press ENTER after entering
each students name) :
Avishkar
Onkar
Original list of students playing cricket is :['Avishkar', 'Onkar']
The list of students playing cricket after removing duplicates : ['Avishkar',
'Onkar']
Enter number of students who play football : 2
Enter the name of 2 students who play football (Please press ENTER after entering
each students name) :
om
raj
Original list of students playing football :['om', 'raj']
The list of students playing football after removing duplicates : ['om', 'raj']
Enter number of students who play badminton : 4
Enter the name of 4 students who play badminton (Please press ENTER after entering
each students name) :
Avishkar
Onkar
om
sahil
Original list of students playing badminton :['Avishkar', 'Onkar', 'om', 'sahil']
The list of students playing badminton after removing duplicates : ['Avishkar',
'Onkar', 'om', 'sahil']
******************MENU*******************
...
list of students who play both cricket and badminton is : ['Avishkar', 'Onkar']
...
Difference between badminton and cricket(B-C) is : ['om', 'sahil']
List of students who play either cricket or badminton but not both is : ['om',
'sahil']
...
List of students who play neither cricket nor badminton is : ['raj', 'yogiraj']
