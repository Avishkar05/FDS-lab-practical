...
Enter the First Year % of Student[0] : 69
Enter the First Year % of Student[1] : 71
Enter the First Year % of Student[2] : 80
Enter the First Year % of Student[3] : 67
Enter the First Year % of Student[4] : 52
...
Enter your choice : 2
 ...
 4. exit
Enter your choice : 3
Elements after sorting using Sort :
	 52.00 	 67.00 	 69.00 	 71.00 	 80.00 
Top five score are : 
	 80.00 	 71.00 	 69.00 	 67.00 	 52.00 
 1. Accept array elements 
 2. Display the Elements 
 3. Quick Sort  
 4. exit
